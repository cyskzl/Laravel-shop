...
@section('x-body')
    <div class="layui-tab layui-tab-brief" lay-filter="test"  >
            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form layui-form-pane" action="{{url('/admin/goods')}}" method="post" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="goods_sn" required="" lay-verify="required" placeholder="如果不填会自动生成" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    {{--<div class="layui-form-item">--}}
        ...
        <center>
            <div style='margin-top: -280px' class="layui-form-item">
                <button class="layui-btn" lay-filter="add" lay-submit>立即发布</input>
