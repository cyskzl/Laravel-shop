...
@section('x-body')
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="url" name="url" required="" lay-verify="required" placeholder="请输入广告url" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入广告描述" class="layui-textarea" name="desc"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
