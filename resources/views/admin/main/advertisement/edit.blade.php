    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="{{$advertisement->name}}" name="name" required="" lay-verify="required" placeholder="请输入广告名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label" style="width: 100px">广告url</label>
            <div class="layui-input-block">
                <input type="url" name="url" value='{{$advertisement->url}}' required="" lay-verify="required" placeholder="请输入广告url" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <select lay-verify="required" name="top_cate_id">
                        ...
                        @foreach($cates as $v)
                            <option @if($advertisement->top_cate_id == $v->id) selected @endif value="{{$v->id}}">{{$v->name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="layui-form-item" >
            ...
            <div class="layui-form-item" >
                ...
                <div class="layui-input-inline" style="margin-left:10px;">
                    <input type="text" disabled name="logo" id="img" autocomplete="off" class="layui-input">
                </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sort" value="{{$advertisement->sort}}" required="" lay-verify="required" placeholder="请输入排序" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">广告描述</label>
            <div class="layui-input-block">
                <textarea placeholder="请输入广告描述" class="layui-textarea" name="desc">{{$advertisement->desc}}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
...
@section('js')
    <script>
        ...
        var uploadPath = "{{url('admin/upload/advertisement')}}"
        //实例化上传函数
        ...
        layui.use(['form','layer','layedit'], function(){
            ...
            form.on('submit(add)', function(data){
                ...
                $.ajax({
                    type: 'post',
                    url:  '/admin/advertisement/'+data.field.id,
                    dataType: 'json',
