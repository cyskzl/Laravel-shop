    ...
    <form class="layui-form"  action=''>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="name"  lay-verify="required" placeholder="支付名称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">显示</label>
            <div class="layui-input-block">
                <input type="checkbox" name="enabled" lay-skin="switch" lay-text="开启|关闭" value="0" checked>
            </div>
        </div>
