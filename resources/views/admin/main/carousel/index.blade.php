...
<div class="x-body">
    <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="banner_add('添加轮播图','{{ url('carousel/create') }}','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                <img  src="{{asset('templates/admin/images/banner.png')}}" width="200" alt="">点击图片试试
            </td>
            <td >
            ...
            <td class="td-manage">
                ...
                <a title="编辑" href="javascript:;" onclick="banner_edit('编辑','{{ url('carousel/1/edit') }}','1','','510')"
