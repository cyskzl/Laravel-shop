...
<div class="x-body">
    <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="level_add('添加等级','{{ url('memberlevel/create') }}','','400')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-manage">
                <a title="编辑" href="javascript:;" onclick="level_edit('编辑','{{ url('memberlevel/1/edit') }}','4','','300')"
