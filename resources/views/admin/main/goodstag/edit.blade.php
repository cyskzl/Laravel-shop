            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="tag_name" required  lay-verify="required" placeholder="请输入标签名称" autocomplete="off" class="layui-input" value="{{ $tag->tag_name }}">
                    </div>
                </div>
        ...
        <script>
            layui.use(['form','layer'], function(){
              ...
              form.on('submit(save)', function(data){
                ...
                // 发异步，把数据提交给php
                $.ajax({
                    url:'{{ url('admin/goodstag') }}' + '/' + data.field.id,
                    type:'put',
                    datatype:'json',
                    data:{
                        '_token':"{{ csrf_token() }}",
