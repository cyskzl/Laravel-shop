<div class="header_top left">
    <ul class="header_top_left left">
        ...
        @if(Auth::check())
            <li><a class="left_memu_personal" href="{{ url('home/personal') }}">{{Auth::user()->login_name}}</a></li>
    ...
    <ul class="header_top_right right">
        <li><a class="left_memu_orders" href="{{url('home/alreadyorder')}}">我的订单</a></li>
        <li><a class="left_memu_favorites1" href="{{url('home/favorites')}}">收藏</a></li>
        <li><a class="left_memu_newest" href="{{url('home/newest')}}">消息</a></li>
        <li class="header_top_right_li"><a href="javascript:;">个人中心</a>&nbsp;
            <span>
            ...
            <div class="header_top_right_div">
                ...
                <a class="left_memu_favorites" href="{{url('home/favorites')}}">收藏夹</a>
                <a class="left_memu_integral" href="{{url('home/integral')}}">W积分</a>
                <a class="left_memu_coupon" href="{{url('home/coupon')}}">优惠券</a>
            </div>
        </li>
