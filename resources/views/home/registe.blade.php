...
<div class="content">
	...
	<main>
	    <div class="main clearfix">
	        <!-- 左侧图片 -->
	        <div class="main-img">
	            <img src="./public/png/account_init.png" alt="">
	        </div>
	        <!-- 右侧表单 -->
	        <div class="main-form">
	            <div class="registe-wray">
	                ...
	                <div class="box_hezi">
	                    ...
	                    <div class="reg-inner">
	                        ...
	                        <div class="code clearfix">
	                            <input type="text" placeholder="请填写图形验证码">
	                            <span>213123</span>
	                        </div>
	                        <input type="password" placeholder="设置密码" id="pass">
	                        <input type="password" placeholder="确认密码" id="pass_again">
                    ...
                    <form action="">
                        <div class="reg-inner">
                            <input type="text" placeholder="请填写邮箱" id="email">
                            <div class="code clearfix">
                                <input type="text" placeholder="请填写图形验证码">
                                <span>213123</span>
                            </div>
	...
	<div class="alert" id="alert">
	    <div class="tip">
	        <img src="./public/png/icon_error.png" alt="">
	        <p id="text"></p>
