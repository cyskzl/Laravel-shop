...
<head>
  ...
  <title>404 NOT FOUND 未找到该页面！</title>

  <!-- <link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:700' rel='stylesheet' type='text/css'> -->

  <link rel="stylesheet" href="{{ asset('templates/home/404/css/reset.css') }}">

    <link rel="stylesheet" href="{{ asset('templates/home/404/css/style.css') }}" media="screen" type="text/css" />
